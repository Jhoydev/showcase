...
<div class="contenedor-escaparate">
    <header>
        ...
        <div id="ctn_title">
            {{ $data->nbtipo }} EN VENTA
        </div>
        <div id="cnt_main_label">
            <div class="cnt_label">
                <div class="first_label">{{ $data->precio }} €</div>
                <div class="second_label">
                    <div class="cnt_icon">
                        2 <img src="images/bed.svg" alt="">
                    </div>
                    <div class="cnt_icon">
                        1 <img src="images/bed.svg" alt="">
                    </div>
                    <div class="cnt_icon">
                        3 <img src="images/bed.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <main>
        ...
        <div id="ctn_fotos">
            <div class="main_foto">
                <img src="{{ $data->foto1 }}" alt="">
            </div>
            <div class="second_foto">
                <img src="{{ $data->foto2 }}" alt="">

            </div>
            <div class="third_foto">
                <img src="{{ $data->foto3 }}" alt="">
            </div>
        </div>
        <div id="ctn_caract">
    ...
    <footer>
        <div class="telefono"><img src="images/phone.svg" alt="">{{ $data->telefono_agente }}</div>
